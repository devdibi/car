...
class _BoardScreenState extends State<BoardScreen> {
  ...
  Map<int, List<BoundingBoxPainter>> paintBoxes = {};
          ...
          Stack(
            children: [
              ...
              // if (paintBoxes['$i']! != null)
                ...
                //     height: 300,
                //     width: 400,
                //     child: CustomPaint(painter: paintBoxes[i]![j]),
                //   ),
            ],
          ),
          SizedBox(height: 50,),
  ...
  Future<void> box(BuildContext context) async {
    try{
      ...
      Map<int, List<BoundingBoxPainter>> tempBox = {
        0 : [],
        1 : [],
        2 : [],
        3 : [],
      ...
      for (int i = 0; i < boxes.length; i++) {
        ...
        tempBox[section]!.add(BoundingBoxPainter(xMin, xMax, yMin, yMax));
      }
      print(tempBox);
